// Te gjitha imazhet jane URL Unsplash - funksionojne gjithmone ne cdo browser
// Asnje URL Figma (skadon), asnje SVG i krijuar, asnje Logitech CDN (referrer block)

export const FIGMA = {
  // === LOGO ===
  // SVG inline (i thjeshte por gjithmone funksionon)
  logo: "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 80 80'><defs><linearGradient id='g' x1='0' y1='0' x2='1' y2='1'><stop offset='0' stop-color='%237c3aed'/><stop offset='1' stop-color='%23ec4899'/></linearGradient></defs><rect width='80' height='80' rx='16' fill='url(%23g)'/><polygon points='28,20 56,40 28,60' fill='white' opacity='0.95'/></svg>",

  // === HOME PAGE ===
  // Hero - shopping bag/hands (Unsplash)
  giveShop:
  ...
  productController:
    "https://images.unsplash.com/photo-1592840496694-26d035b52b48?w=800&h=800&fit=crop&q=80",

  // Video background (gaming setup)
  videoBg:
    "https://images.unsplash.com/photo-1542751371-adc38448a05e?w=1600&h=600&fit=crop&q=80",

  // Furniture - URL te reja te verifikuara
  chair:
    "https://images.unsplash.com/photo-1592078615290-033ee584e267?w=800&h=800&fit=crop&q=80",
  table:
    "https://images.unsplash.com/photo-1547082299-de196ea013d6?w=800&h=800&fit=crop&q=80",
  lamp: "https://images.unsplash.com/photo-1513506003901-1e6a229e2d15?w=800&h=800&fit=crop&q=80",
  ...
  blog2:
    "https://images.unsplash.com/photo-1595044426077-d36d9236d54a?w=800&h=500&fit=crop&q=80",
  blog3:
  ...
  keyboardRgb:
    "https://images.unsplash.com/photo-1595044426077-d36d9236d54a?w=800&h=800&fit=crop&q=80",

  // === SHOP/[slug] - Product Details (pink headset variants) ===
  productHeadsetPink:
    "https://images.unsplash.com/photo-1599669454699-248893623440?w=800&h=800&fit=crop&q=80",
  productHeadsetPinkSide:
    "https://images.unsplash.com/photo-1583394838336-acd977736f90?w=800&h=800&fit=crop&q=80",
  productHeadsetPinkBox:
    "https://images.unsplash.com/photo-1545127398-14699f92334b?w=800&h=800&fit=crop&q=80",
  productHeadsetPinkModel:
