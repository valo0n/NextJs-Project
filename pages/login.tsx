...
const Login: NextPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Login - Paradox Tech</title>
      </Head>
      ...
      <div className="min-h-screen bg-paradox-bg relative overflow-hidden flex items-center justify-center px-4 py-12">
        ...
        {/* Logo lart */}
        <Link href="/" className="absolute top-6 left-6 lg:top-8 lg:left-12 z-20">
          <img
            src={FIGMA.logo}
            alt="Paradox Tech"
        ...
        <div className="relative z-10 w-full max-w-md">
          {/* Border me kornize asimetrike si Paradox Tech */}
          <div
          ...
          >
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <div className="text-right">
                <Link href="#" className="text-sm text-gray-300 hover:text-[#cf35d2] transition">
              ...
              <button
                ...
                style={{
                  background: "linear-gradient(65deg, rgb(63, 50, 220) 0%, rgb(207, 53, 210) 100%)",
                }}
              >
                {loading ? (
