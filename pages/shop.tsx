        ...
        <section className="min-h-screen bg-paradox-bg pt-32 pb-20 px-6">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_280px] gap-12">
              ...
              <div>
                <div className="flex justify-between items-center mb-8">
                  <h1 className="text-sm text-[#ececec]">Sort by popularity</h1>
                </div>
                ...
                <div className="mb-10">
                  ...
                  <ul className="space-y-3 text-sm text-[#ececec]/80">
                    {categories.map((category) => (
                      <li key={category}>
                        <Link href="/shop/logitech-g-pro-x" className="hover:text-white transition">
                          {category}
                        </Link>
                      </li>
                    ))}
            ...
            <div className="text-right mt-12">
              <Link href="/shop/logitech-g-pro-x" className="text-sm text-[#ececec]/70 hover:text-white">
                view all
              </Link>
            </div>
          </div>
